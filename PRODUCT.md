...
**当前聚焦**：从「相机工具」向「AI 相册助手」转型，以相册首页为核心入口，相册整理/聊天/打标/人物由底部悬浮 Tab 聚合（主页面 Pager），相机为路由化全屏页（仅头像拍摄进入），模型中心入口位于相册顶栏与设置主菜单，设置入口位于顶部栏最右侧，相册/编辑作为核心能力被 Agent 调度。
...
- 底部悬浮导航聚合 相册整理 / 聊天 / 打标 / 人物四个入口（纯图标无文字标签），点击瞬时切主页面 Pager 页，降低首次使用成本
