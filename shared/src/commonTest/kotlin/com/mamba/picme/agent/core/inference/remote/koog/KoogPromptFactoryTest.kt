...
class KoogPromptFactoryTest {
    ...
    fun `baseParams 完整落入 Prompt params`() {
        ...
        assertNotNull(thinking, "thinking 必须保留在 additionalProperties")
        assertTrue(thinking is JsonObject, "thinking 须为 JsonObject")
    ...
    fun `system message 内容与 prompt id 正确`() {
        ...
        assertNotNull(systemMsg, "Prompt 必须包含 System 消息")
    ...
    fun `空 additionalProperties 时不引入 thinking`() {
        ...
        assertNull(prompt.params.additionalProperties)
    }
}
