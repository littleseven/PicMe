...
| **架构决策** | [`02-ARCHITECTURE/ADR/ADR-001`](./02-ARCHITECTURE/ADR/ADR-001-beauty-engine-architecture.md) | ADR-001 ~ ADR-007（已实施） |
...
| **QA 验收** | [`06-QA/QA_EXECUTION_CHECKLIST.md`](./06-QA/QA_EXECUTION_CHECKLIST.md) | 端到端验收、自动化测试 |
...
| [`ON_DEVICE_INFERENCE_INVENTORY_TECH_SPEC.md`](./03-TECHNICAL-SPECS/ON_DEVICE_INFERENCE_INVENTORY_TECH_SPEC.md) | 端侧推理引擎与模型全景梳理 |
...
- **执行 QA 验收** → [QA_EXECUTION_CHECKLIST](./06-QA/QA_EXECUTION_CHECKLIST.md) → [BEAUTY_ENGINE_TECH_SPEC](./03-TECHNICAL-SPECS/BEAUTY_ENGINE_TECH_SPEC.md)
