...
enum AppColorScheme {
    static let light = SchemeColors(
        primary: Color(hex: "FF6750A4"),
        onPrimary: Color.white,
        primaryContainer: Color(hex: "FFEADDFF"),
        onPrimaryContainer: Color(hex: "FF21005D"),
        secondary: Color(hex: "FF625B71"),
        onSecondary: Color.white,
        secondaryContainer: Color(hex: "FFE8DEF8"),
        onSecondaryContainer: Color(hex: "FF1D192B"),
        tertiary: Color(hex: "FF7D5260"),
        onTertiary: Color.white,
        tertiaryContainer: Color(hex: "FFFFD8E4"),
        onTertiaryContainer: Color(hex: "FF31111D"),
        error: Color(hex: "FFB3261E"),
        onError: Color.white,
        errorContainer: Color(hex: "FFF9DEDC"),
        onErrorContainer: Color(hex: "FF410E0B"),
        background: Color(hex: "FFFFFBFE"),
        onBackground: Color(hex: "FF1C1B1F"),
        surface: Color(hex: "FFFFFBFE"),
        onSurface: Color(hex: "FF1C1B1F"),
        surfaceVariant: Color(hex: "FFE7E0EC"),
        onSurfaceVariant: Color(hex: "FF49454F"),
        outline: Color(hex: "FF79747E"),
        outlineVariant: Color(hex: "FFCAC4D0"),
        surfaceContainerLowest: Color.white,
        surfaceContainerLow: Color(hex: "FFF7F2FA"),
        surfaceContainer: Color(hex: "FFF3EDF7"),
        surfaceContainerHigh: Color(hex: "FFEDE7F0"),
        surfaceContainerHighest: Color(hex: "FFE6E0E9")
    )

    static let dark = SchemeColors(
        primary: Color(hex: "FFD0BCFF"),
        onPrimary: Color(hex: "FF381E72"),
        primaryContainer: Color(hex: "FF4F378B"),
        onPrimaryContainer: Color(hex: "FFEADDFF"),
        secondary: Color(hex: "FFCCC2DC"),
        onSecondary: Color(hex: "FF332D41"),
        secondaryContainer: Color(hex: "FF4A4458"),
        onSecondaryContainer: Color(hex: "FFE8DEF8"),
        tertiary: Color(hex: "FFEFB8C8"),
        onTertiary: Color(hex: "FF492532"),
        tertiaryContainer: Color(hex: "FF633B48"),
        onTertiaryContainer: Color(hex: "FFFFD8E4"),
        error: Color(hex: "FFF2B8B5"),
        onError: Color(hex: "FF601410"),
        errorContainer: Color(hex: "FF8C1D18"),
        onErrorContainer: Color(hex: "FFF9DEDC"),
        background: Color(hex: "FF1C1B1F"),
        onBackground: Color(hex: "FFE6E1E5"),
        surface: Color(hex: "FF1C1B1F"),
        onSurface: Color(hex: "FFE6E1E5"),
        surfaceVariant: Color(hex: "FF49454F"),
        onSurfaceVariant: Color(hex: "FFCAC4D0"),
        outline: Color(hex: "FF938F99"),
        outlineVariant: Color(hex: "FF49454F"),
        surfaceContainerLowest: Color(hex: "FF0F0D13"),
        surfaceContainerLow: Color(hex: "FF1D1B20"),
        surfaceContainer: Color(hex: "FF211F26"),
        surfaceContainerHigh: Color(hex: "FF2B2930"),
...
enum BeautyPanelTokens {
    ...
    static let heightRatio: Double = 0.35
