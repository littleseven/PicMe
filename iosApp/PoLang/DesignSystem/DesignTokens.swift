...
enum AppColorScheme {
    static let light = SchemeColors(
        primary: Color(hex: "FF0D63D6"),
        onPrimary: Color.white,
        primaryContainer: Color(hex: "FFCFE5FF"),
        onPrimaryContainer: Color(hex: "FF062E6B"),
        secondary: Color(hex: "FF44618C"),
        onSecondary: Color.white,
        secondaryContainer: Color(hex: "FFD8E2F5"),
        onSecondaryContainer: Color(hex: "FF0C1B33"),
        tertiary: Color(hex: "FF0F7C92"),
        onTertiary: Color.white,
        tertiaryContainer: Color(hex: "FFC7F0F7"),
        onTertiaryContainer: Color(hex: "FF04303B"),
    ...
    static let dark = SchemeColors(
        primary: Color(hex: "FF7FC9FF"),
        onPrimary: Color(hex: "FF00325B"),
        primaryContainer: Color(hex: "FF0F5AA8"),
        onPrimaryContainer: Color(hex: "FFD5E9FF"),
        secondary: Color(hex: "FFB3CCF0"),
        onSecondary: Color(hex: "FF1D3350"),
        secondaryContainer: Color(hex: "FF324B70"),
        onSecondaryContainer: Color(hex: "FFD3E1F8"),
        tertiary: Color(hex: "FF7ADCE6"),
        onTertiary: Color(hex: "FF003740"),
        tertiaryContainer: Color(hex: "FF00505C"),
        onTertiaryContainer: Color(hex: "FF97F0F9"),
