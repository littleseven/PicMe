...
### [通用] 前置调研缺失
- [ ] **编码前检索相关 skill**：`ls skills/` 查看是否有相关 skill（adb-bot / av-gl-expert / coordinate-system-standard 等）
...
- [ ] **修改代码后必须重新打包**：`./gradlew :androidApp:assembleDebug`，`compileDebugKotlin` 不会生成新 APK
