...
name: ios-dev-loop
description: |
  iOS 编译→模拟器安装→启动→截屏→对比的闭环验证流程。Use when verifying an iOS change end-to-end on simulator, comparing against a baseline screenshot, or running scripts/ios-dev-loop.sh.
version: 1.0.0
created: 2026-08-08
updated: 2026-08-08
maintainer: [RD] 全栈工程师
