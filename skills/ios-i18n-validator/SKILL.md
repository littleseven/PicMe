...
description: |
  iOS 三语（EN/zh-CN/zh-TW）文案同步与规范验证。Use when adding/refactoring user-facing SwiftUI strings, syncing Localizable.xcstrings, or checking for hardcoded iOS UI text.
version: 1.0.0
created: 2026-08-08
updated: 2026-08-08
maintainer: [RD] 全栈工程师
