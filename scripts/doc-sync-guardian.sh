...
declare -a DOC_MAP_PAIRS=(
    ...
    "androidApp/src/main/res/values/strings.xml|docs/01-PRODUCT/FEATURES.md|androidApp/src/main/res/values-zh-rCN/strings.xml|androidApp/src/main/res/values-zh-rTW/strings.xml|androidApp/src/main/res/values-es/strings.xml|androidApp/src/main/res/values-fr/strings.xml"
    "androidApp/src/main/res/values-zh-rCN/strings.xml|androidApp/src/main/res/values/strings.xml|androidApp/src/main/res/values-zh-rTW/strings.xml|androidApp/src/main/res/values-es/strings.xml|androidApp/src/main/res/values-fr/strings.xml"
    "androidApp/src/main/res/values-zh-rTW/strings.xml|androidApp/src/main/res/values/strings.xml|androidApp/src/main/res/values-zh-rCN/strings.xml|androidApp/src/main/res/values-es/strings.xml|androidApp/src/main/res/values-fr/strings.xml"
    "AGENTS.md|AGENTS.md"
